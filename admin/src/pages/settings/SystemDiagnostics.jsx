...
export default function SystemDiagnostics() {
  ...
  const runDiagnostics = async () => {
    ...
    setDiagnostics(prev => ({
      ...prev,
      lastCheck: new Date().toLocaleTimeString(),
      cpu: { ...prev.cpu, usage: Math.floor(Math.random() * 100) },
      memory: { ...prev.memory, usage: Math.floor(Math.random() * 100) }
    }));
  };
      ...
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
            ...
            <div>
              <strong>Dernière vérification:</strong> {diagnostics.lastCheck}
            </div>
            <div>
