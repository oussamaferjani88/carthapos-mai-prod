/**
 * POSGenerator Component (Refactored)
 * Main orchestrator for POS generation workflow
...
export default function POSGenerator() {
  ...
  // Auto-select first client and sector when loaded
  useEffect(() => {
  ...
  // Render step 2.5 (template vs custom choice)
  ...
  // Render step 2.7 (template selection)
              ...
              <CardContent>
                <div className="space-y-3">
                  ...
                  <div className="flex gap-2 pt-2">
                    <Button
                      onClick={() => {
                        // Apply template and go directly to license step
                    ...
                    <Button
                      onClick={() => {
                        // Apply template and open customizer
                        configHook.updateConfig('businessName', template.name);
                        configHook.updateConfig('primaryColor', template.color);
                        configHook.updateConfig('sector', template.sector);
  ...
  // Render step 3 (customization with preview)
