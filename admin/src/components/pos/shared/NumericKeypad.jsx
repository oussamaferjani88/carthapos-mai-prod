...
export const NumericKeypad = ({ onNumberClick, onOperationClick, onClear, onEnter, currentValue = "" }) => {
  const numbers = [
    ['7', '8', '9'],
    ['4', '5', '6'], 
    ['1', '2', '3'],
    ...
    <Card className="w-full">
      <CardHeader className="pb-3">
        <CardTitle className="text-lg flex items-center justify-between">
          🔢 Clavier Numérique
          <div className="text-right bg-gray-100 px-3 py-1 rounded text-xl font-mono min-w-[120px]">
            {currentValue || "0"}
          </div>
        </CardTitle>
      </CardHeader>
        ...
        <div className="grid grid-cols-4 gap-2">
          {operations.map((op) => (
            <button
              ...
              className="h-10 bg-orange-500 hover:bg-orange-600 text-white rounded-lg font-bold transition-all hover:scale-105"
              title={op.label}
            >
