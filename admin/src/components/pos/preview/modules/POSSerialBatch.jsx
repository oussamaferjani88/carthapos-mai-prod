...
export const POSSerialBatch = ({ config }) => {
  const serialNumbers = [
    { 
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <Card style={styles.card}>
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-gray-500">Séries Actives</p>
                <p className="text-2xl font-bold" style={{ color: config.primaryColor }}>45</p>
              </div>
        ...
        <Card style={styles.card}>
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-gray-500">Lots en Stock</p>
        ...
        <Card style={styles.card}>
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-gray-500">À Expirer</p>
              ...
              {serialNumbers.map((item, index) => (
                <div key={index} className="border rounded-lg p-3">
                  <div className="flex justify-between items-start mb-2">
                    <div className="font-mono text-sm font-semibold" style={{ color: config.primaryColor }}>
                      {item.serial}
                    </div>
                ...
                <div key={index} className="border rounded-lg p-3">
                  ...
                  <div className="flex justify-between text-xs">
                    ...
                    <span className={`font-semibold ${
                      batch.status === 'urgent' ? 'text-red-600' : 
