...
export const POSVariants = ({ config }) => {
            ...
            <CardContent>
              ...
              <div className="space-y-2">
                ...
                {product.variants.map((variant, idx) => (
                  <div 
                    key={idx} 
                    className="grid grid-cols-4 gap-2 text-sm py-2 hover:bg-gray-50 rounded px-2 -mx-2"
                  >
                    ...
                    <div className="flex items-center gap-2">
                      <div 
                        ...
                        style={{ 
                          backgroundColor: getColorDot(variant.color),
                          borderColor: variant.color === 'Blanc' ? '#d1d5db' : 'transparent'
                        }}
                      />
                      {variant.color}
                    </div>
                    <div className={`font-semibold ${variant.stock < 10 ? 'text-orange-600' : 'text-green-600'}`}>
                      {variant.stock}
                    </div>
