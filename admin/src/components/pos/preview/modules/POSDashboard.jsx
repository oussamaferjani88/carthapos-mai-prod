...
// Tableau de bord compact qui remplit tout le viewport : en-tête réduit,
// rangée de 6 KPIs, puis une grille 2/3-1/3 dont les colonnes s'étirent sur
// toute la hauteur disponible (le graphique et la santé absorbent l'espace).
export const POSDashboard = ({ config }) => {
    ...
    <div className="h-full flex flex-col gap-3">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-6 gap-3 flex-shrink-0">
        {KPIS.map((kpi, idx) => {
          const Icon = kpi.icon;
          return (
            <div key={idx} className="flex items-center gap-3 rounded-xl border p-3 transition-shadow hover:shadow-md"
