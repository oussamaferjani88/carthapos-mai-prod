...
export const POSRental = ({ config }) => {
  const rentals = [
    {
      id: 'LOC-001',
      customer: 'Société XYZ',
      item: 'Échafaudage 10m',
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <Card style={styles.card}>
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-gray-500">CA Location</p>
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-blue-600">15/26</p>
              </div>
              ...
              {rentals.map((rental) => (
                <div key={rental.id} className="border rounded-lg p-4 hover:bg-gray-50 transition">
                  <div className="flex justify-between items-start mb-3">
                    ...
                    <div className="text-right">
                      <div className="text-xl font-bold" style={{ color: config.primaryColor }}>
                        {(rental.dailyRate * rental.days).toFixed(2)}€
                      </div>
                  ...
                  {rental.status === 'active' && (
                    <Button size="sm" className="mt-3" style={{ backgroundColor: config.primaryColor }}>
                      Marquer Retourné
                    </Button>
                  )}
                </div>
              ...
              {inventory.map((item, index) => (
                <div key={index} className="border rounded-lg p-3">
                  ...
                  <div className="flex justify-between items-center mb-2">
                    ...
                    <span className={`font-bold ${item.available === 0 ? 'text-red-600' : 'text-green-600'}`}>
