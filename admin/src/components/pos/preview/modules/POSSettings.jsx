          ...
          <Card style={styles.card}>
            ...
            <CardContent className="space-y-4">
              <div className="grid gap-2">
                ...
                <Input
                  id="businessName"
                  value={config.businessName || 'Mon établissement'}
                  readOnly
          ...
          <Card style={styles.card}>
            ...
            <CardContent>
              ...
              <Button
                variant="outline"
                className="w-full"
                onClick={handleOpenReceiptDesigner}
              >
          ...
          <Card style={styles.card}>
            ...
            <CardContent className="space-y-3">
              <div>
                ...
                <p className="text-sm font-mono" style={{ color: config.textMutedColor }}>
                  DEMO-XXXX-XXXX-XXXX
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-sm capitalize" style={{ color: config.textMutedColor }}>
                  Restauration
                </p>
              </div>
          ...
          <Card style={styles.card}>
            ...
            <CardContent className="space-y-3">
              ...
              <div>
                ...
                <p className="text-xs break-all font-mono" style={{ color: config.textMutedColor }}>
                  C:\ProgramData\POS\database.db
                </p>
              </div>
