...
export const POSCustomers = ({ config, setNotification }) => {
  ...
  const stats = {
    ...
    avgVisits: customers.length > 0
      ? customers.reduce((s, c) => s + (c.visit_count || 0), 0) / customers.length
      : 0
  };
        ...
        <DialogContent className="sm:max-w-[520px] max-h-[85vh] flex flex-col">
          ...
          <form onSubmit={handleSubmit} className="space-y-4 overflow-y-auto pr-1">
            ...
            <div className="grid gap-2">
              ...
              <Input type="number" min="0" value={formData.loyalty_points} onChange={(e) => setFormData({ ...formData, loyalty_points: e.target.value })} />
