...
export const POSEmployeeManagement = ({ config }) => {
  const employees = [
    { 
      id: 1, 
      name: 'Marie Dupont', 
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold" style={{ color: config.primaryColor }}>4</p>
              </div>
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-purple-600">465.40€</p>
              </div>
            ...
            {employees.map(employee => (
              <div key={employee.id} className="border rounded-lg p-4 hover:bg-gray-50 transition">
                ...
                <div className="grid grid-cols-4 gap-4 text-sm">
                  <div>
                    <div className="text-gray-500 text-xs mb-1">Ventes</div>
                    <div className="font-semibold text-green-600">{employee.sales}</div>
                  </div>
                  <div>
                    <div className="text-gray-500 text-xs mb-1">Heures Semaine</div>
                    <div className="font-semibold text-blue-600">{employee.hours}h</div>
                  </div>
                  <div>
                    <div className="text-gray-500 text-xs mb-1">Commissions</div>
                    <div className="font-semibold text-purple-600">{employee.commission.toFixed(2)}€</div>
                  </div>
