...
export default function LiquidEther({
  ...
  useEffect(() => {
    ...
    class MouseClass {
      ...
      _onMouseMove: ((event: MouseEvent) => void) | null = null;
      _onTouchStart: ((event: TouchEvent) => void) | null = null;
      _onTouchMove: ((event: TouchEvent) => void) | null = null;
      _onTouchEnd: (() => void) | null = null;
      _onDocumentLeave: (() => void) | null = null;
...
`;
    ...
    class WebGLManager {
      ...
      _loop: (() => void) | null = null;
      _resize: (() => void) | null = null;
