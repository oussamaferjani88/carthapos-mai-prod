...
// Split out of AdvancedSettings.tsx to match the admin panel's layout
// (admin/src/components/customizer/BrandPanel.jsx) - same fields/behavior
// that already existed in the client customizer, just its own nav section now.
const BrandPanel = ({ formData, setFormData }: BrandPanelProps) => {
