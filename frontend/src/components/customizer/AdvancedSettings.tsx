          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between p-3 rounded-lg border bg-accent/5">
              ...
              <Switch
                ...
                onCheckedChange={(checked) => handleBusinessInfoChange('animations', checked)}
              />
            </div>
            <div className="flex items-center justify-between p-3 rounded-lg border bg-accent/5">
              <div>
              ...
              <Switch
                ...
                onCheckedChange={(checked) => handleBusinessInfoChange('autoModeSwitch', checked)}
              />
            </div>
            <div className="flex items-center justify-between p-3 rounded-lg border bg-accent/5">
              <div>
              ...
              <Switch
                ...
                onCheckedChange={(checked) => handleBusinessInfoChange('autoSave', checked)}
              />
            </div>
          </div>
        </div>
