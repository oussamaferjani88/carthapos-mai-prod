...
// Ported from admin/src/components/customizer/CustomizerHeader.jsx (dark bar
// instead of the previous blue-purple gradient). exportConfiguration/
// duplicateConfiguration/showAdvanced/setShowAdvanced are accepted for
// backward compatibility with POSCustomizer.tsx's call site but were already
// not rendered by the previous header either - no functionality removed.
const CustomizerHeader = ({
  mode, onBack, onCancel, onSave, resetToDefaults,
  importConfiguration, fileInputRef, lastSaved, onToggleSidebar, isDirty = false,
