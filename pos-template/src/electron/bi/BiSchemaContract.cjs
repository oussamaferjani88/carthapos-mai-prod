...
const SCHEMAS = {
  ...
  kitchen_orders: {
    columns: [
      ...
      { name: 'table_number', type: 'integer',  required: false, description: 'Source table number' },
      ...
      { name: 'priority',     type: 'text',     required: false, description: 'Priority level (normal/high/urgent)' },
      { name: 'status',       type: 'text',     required: false, description: 'Order status (pending/preparing/completed)' },
